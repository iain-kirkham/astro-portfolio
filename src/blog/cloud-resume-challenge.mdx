...
## Building a serverless backend—The Rust way
...
While these numbers may seem small, they add up quickly at scale and demonstrate a massive gain in efficiency from using Rust.
...
I also decided to have a look at the Mozilla HTTP docs for [CORS](https://developer.mozilla.org/en-US/docs/Web/HTTP/CORS#access-control-allow-origin),
which confirmed that my CORS middleware was working as intended.
...
To display visitor data on my frontend, I integrated my API with Astro and React. Astro handles the static structure of the page,
...
This turned out to be more challenging than I expected, due to using the cargo lambda tool, which requires a local installation of Zig for ARM64.
I also had issues with OIDC as I had not configured the GitHub repository to allow access to the AWS account.
However once I had everything working, it was as easy as pushing a commit to the main branch, and the website and backend was automatically deployed.

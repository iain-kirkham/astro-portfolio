...
and what has affected my mood, allowing me to better plan my days. I would also like a pomodoro timer to help me stay focused
and give myself feedback on sessions, so I can improve my productivity, over time. Finally, I would like to be able to track my
daily tasks and schedule them for the week, so I can stay on top of my schedule and stay focused.
...
Shadcn/ui provides customisable components, allowing for perfect integration with my design while offering great accessibility features.
...
For containerisation, I will be using Docker. Docker is a powerful tool for building, deploying, and testing applications in a reproducible environment.
It's a great choice for this project as it allows me to easily deploy the application to a cloud platform like AWS,
and also allows me to easily run my application and database locally in development.

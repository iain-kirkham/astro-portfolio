...
description: "A work-in-progress Nintendo Game Boy (DMG-01) emulator written in Rust with CPU, memory bus, timer, and interrupt support."
publishDate: 2026-03-16
githubUrl: "https://github.com/iain-kirkham/rusty_gameboy_emulator"
technologies: ["Rust", "Assembly", "Systems Programming", "Emulation"]
status: "In Progress"
---
